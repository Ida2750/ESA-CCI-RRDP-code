...
ofile = '/media/s174020/My Passport2/ESACCIplus/RRDPp/FINAL/OIB/final/ESACCIplus-SEAICE-RRDP2+-SIT-OIB-IDCS4-test.dat'
directory = '/media/s174020/My Passport2/ESACCIplus/RRDPp/RawData/OIB/IDCS4'
    ...
    if os.path.isdir(dir_data):        
        for ifile in os.listdir(dir_data):
            ...
            if file.endswith('txt'):
                ...
                # Correlate OIB buoy data with Warren snow depth and snow density
                w_SD_final      = []
                w_density_final = []
                ...
                if count == 1: # make empty output file with header
                    output = open(ofile,'w')
                # if ifile == 'IDCSI4_20090331.txt' or ifile == 'OIB_20140312_IDCSI2.txt': 
                    # print header
